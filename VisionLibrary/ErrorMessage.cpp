...
VisionStatus GetErrorInfo(VisionStatus enStatus, PR_GET_ERROR_INFO_RPY *pstRpy)
{
    ...
    case VisionStatus::CALC_3D_HEIGHT_DIFF_FAIL:
        _snprintf(pstRpy->achErrorStr, PR_MAX_ERR_STR_LEN, "Failed to calcualte 3D height difference.");
        pstRpy->enErrorLevel = PR_STATUS_ERROR_LEVEL::PR_INSP_STATUS;
        break;
    ...
    case VisionStatus::OCV_MATCH_SCORE_UNDER_LIMIT:
        _snprintf(pstRpy->achErrorStr, PR_MAX_ERR_STR_LEN, "The OCV match score is under limit.");
        pstRpy->enErrorLevel = PR_STATUS_ERROR_LEVEL::PR_INSP_STATUS;
        break;
    ...
    case VisionStatus::TABLE_MAPPING_FAIL:
        _snprintf(pstRpy->achErrorStr, PR_MAX_ERR_STR_LEN, "Table mapping failed.");
        pstRpy->enErrorLevel = PR_STATUS_ERROR_LEVEL::PR_FATAL_ERROR;
        break;
