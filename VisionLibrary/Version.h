...
//2019-09-03 (XSG) Support multiple thread inspection.
#define AOI_VISION_VERSION          "1.00.77"

//2019-08-22 (XSG) Move height check to vision library.
//#define AOI_VISION_VERSION          "1.00.76"
