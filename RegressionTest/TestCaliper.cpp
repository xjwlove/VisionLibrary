...
void TestFindLineByCaliper() {
    ...
    std::cout << std::endl << "------------------------------------------------";
    std::cout << std::endl << "FIND LINE BY CALIPER REGRESSION TEST #5 STARTING";
    std::cout << std::endl << "------------------------------------------------";
    std::cout << std::endl;

    stCmd.matInputImg = cv::imread("./data/Caliper_Test_1.png");
    rectROI = cv::Rect(0, 0, stCmd.matInputImg.cols, stCmd.matInputImg.rows);
    stCmd.rectRotatedROI.center = cv::Point(rectROI.x + rectROI.width / 2, rectROI.y + rectROI.height / 2);
    stCmd.rectRotatedROI.size = rectROI.size();
    stCmd.enDetectDir = PR_CALIPER_DIR::DARK_TO_BRIGHT;
    stCmd.fExpectedAngle = 0;
    ...
    std::cout << std::endl << "------------------------------------------------";
    std::cout << std::endl << "FIND LINE BY CALIPER REGRESSION TEST #6 STARTING";
    std::cout << std::endl << "------------------------------------------------";
    std::cout << std::endl;

    stCmd.matInputImg = cv::imread("./data/Caliper_Test_2.png");
    rectROI = cv::Rect(0, 0, stCmd.matInputImg.cols, stCmd.matInputImg.rows);
    stCmd.rectRotatedROI.center = cv::Point(rectROI.x + rectROI.width / 2, rectROI.y + rectROI.height / 2);
    stCmd.rectRotatedROI.size = rectROI.size();
    stCmd.enDetectDir = PR_CALIPER_DIR::DARK_TO_BRIGHT;
    stCmd.fExpectedAngle = 90.f;
